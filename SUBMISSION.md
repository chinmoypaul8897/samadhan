...
- **Firebase** — Auth (anonymous, upgradeable to phone-OTP), Firestore (the full data model with live `onSnapshot` for the agent trace and timelines), Storage (citizen photos + before/after proof), Cloud Messaging (status push).
